...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief creates a button at x,y with text
  \return type struct button
  \param x of type int
  \param y of type int
  \param text of type char*
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief reserves the memory for n integers
  \return type int *
  \param n of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief prints the array to the terminal for debugging
  \param p of type int *
  \param n of type int
  \param m of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief prints the board to the terminal for debugging
  \param p of type int *
  \param n of type int
  \param m of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief fills an array with n mines randomly
  \param m of type int *
  \param n of type int
  \param n_mines of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief fills an array with the number of neighbors that are mines for each cell
  \param p of type int *
  \param mines of type int *
  \param n of type int
  \param m of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief a recursive function that uncovers the cells around a given cell
  \return type int
  \param mines of type int *
  \param neighbors of type int *
  \param board of type int *
  \param n of type int
  \param m of type int
  \param i of type int
  \param j of type int
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief the function to uncover the board from a given point
  \return type int
  \param mines of type int *
  \param neighbors of type int *
  \param board of type int *
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief counts the number of covered cells and flags on the board - used in the win condition
  \return type int
  \param board of type int *
  \param n of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief draws the minesweeper board to the terminal
  \param board of type int *
  \param n of type int
  \param m of type int
  \param xoffset of type int
  \param yoffset of type int
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief draw a button to the terminal
  \param b of type struct button
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief game loop for ending the game
  \param board of type int *
  \param n of type int
  \param m of type int
  \param won of type int
  \param xoffset of type int
  \param yoffset of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief function that resizes the terminal and keeps everything centered
  \param n of type int
  \param m of type int
  \param xoffset of type int *
  \param yoffset of type int *
  \param centered of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief used in the ai - counts the number of flags and mines around a given cell
  \return type int
  \param board of type int *
  \param n of type int
  \param m of type int
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief finds the optimal place to place a flag or uncover a cell
  \return type int
  \param board of type int *
  \param n of type int
  \param m of type int
...
void initNcurse(int* ROW, int* COL){
	...
	*COL = y;
	...
	// Enables keypad mode
 	// This makes (at least for me) mouse events getting
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief draws the title screen to the terminal
  \param x of type int
  \param y of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief game loop for the help screen
  \param xcenter of type int
  \param ycenter of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief game loop for the choose difficulty screen
  \return type int
  \param xcenter of type int
  \param ycenter of type int
*/
...
/*! 
  ...
  \version 0.1
  \date 18-01-22
  \brief game loop for playing the game
  \return type int
  \param n of type int
  \param m of type int
  \param n_mines of type int
